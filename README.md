...
├── imageAsyncCheckDemo.js　图片离线检测接口演示
├── imageAsyncResultDemo.js　图片离线检测结果获取接口演示
├── imageListSubmitDemo.js　图片名单添加接口演示
├── imageListQueryDemo.js　 图片名单查询接口演示
├── imageListUpdateDemo.js　图片名单更新接口演示
├── imageListDeleteDemo.js　图片名单删除接口演示
...
└── liveVideoImageQueryDemo.js 直播视频截图查询接口演示
└── liveVideoFeedbackDemo.js 直播视频信息同步更新接口演示
...
├── liveAudioFeedbackDemo.js 直播语音信息同步更新接口演示
...
├── liveVideoSolutionFeedbackDemo.js　直播音视频解决方案信息同步更新接口演示
├── liveVideoSolutionQueryMonitorDemo.js　直播音视频解决方案人审操作查询接口演示
├── liveVideoSolutionQueryAudioDemo.js　直播音视频解决方案直播音频片段查询接口演示
